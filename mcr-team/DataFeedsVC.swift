...
class DataFeedsVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
            ...
            case .success(_):
                if response.result.value != nil{
                    ...
                    if let dict = response.result.value as? Dictionary<String, AnyObject> {
                        ...
                        if let tel1 = dict["UserLatitude"] as? String {
                            
                            let lat = tel1
                            
                            if let tel12 = dict["UserLatitude"] as? String {
                             
                                self.data_placeUser.text = "\(lat) \(tel12)"
                            }
...
extension DataFeedsVC: HandleMapSearch {
...
extension DataFeedsVC : CLLocationManagerDelegate {
...
extension DataFeedsVC : MKMapViewDelegate {
